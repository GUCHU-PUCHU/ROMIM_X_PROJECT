...
monitor.on('up', (res) => logger(`${res.address}:${res.port} IS ONLINE!!`, "[ 「 𝐍𝐀𝐙𝐑𝐔𝐋  」 ]"));
...
/*const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! THIS BOT WAS MADE BY TANVIR AHMED- DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯");
    res.end();
});
...
app.listen(port, () =>
	logger(`Your app is listening a http://localhost:${port}`, "[ 「 𝐍𝐀𝐙𝐑𝐔𝐋  」 ]")
     );      


logger("Opened server site...", "[ Starting ]");
logger("Opening Uptime Monitor by SI 「 𝐍𝐀𝐙𝐑𝐔𝐋  」...", "[ Starting ]")
...
axios.get("https://raw.githubusercontent.com/Toxic-Sabbir/toxic-legend/main/package.json").then((res) => {
...
// THIZ BOT WAS MADE BY ME(TANVIR) AND MY BROTHER NAYAN - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
