...
exports.crossOriginIsolation = void 0;
...
function crossOriginIsolation() {
    ...
    return function isolated(req, res, next) {
        res.setHeader('Cross-Origin-Opener-Policy', 'same-origin');
        res.setHeader('Cross-Origin-Embedder-Policy', 'require-corp');
        next();
    };
}
exports.crossOriginIsolation = crossOriginIsolation;
//# sourceMappingURL=cross-origin-isolation.js.map