...
exports.getConfigs = exports.readConfig = void 0;
const resolve_config_1 = require("./utils/resolve-config");
const git_1 = require("./utils/git");
const normalize_1 = require("./utils/normalize");
function generateProjectConfigs(options, isRoot, gitInfo) {
    let globalConfig;
    if (isRoot) {
        if (!gitInfo) {
...
async function getConfigs(projectsFromCLIArgs, cliOptions) {
    let globalConfig;
    let configs = [];
    let projects = [];
    let configPath;
