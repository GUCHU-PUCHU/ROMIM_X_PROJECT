...
class RunnerRemote {
    constructor(benchmarksBuilds, runnerLogStream, config) {
        ...
        this._onBenchmarkError = THROW_FUNCTION;
        this._onBenchmarksRunSuccess = THROW_FUNCTION;
    ...
    [BENCHMARK_UPLOAD_REQUEST]() {
        ...
        this.socket.emit(shared_1.BEST_RPC.BENCHMARK_UPLOAD_RESPONSE, benchmarkConfig, async (benchmarkSignature) => {
