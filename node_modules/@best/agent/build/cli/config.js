...
exports.getRemoteHubConfig = exports.getAgentConfig = void 0;
 ...
 */
function tryConvertToBoolean(val) {
...
function getRemoteHubConfig() {
    return {
        ...
        acceptSelfSignedCert: (0, utils_1.coalesce)(tryConvertToBoolean(argv.acceptSelfSignedCert), tryConvertToBoolean(REMOTE_HUB_ACCEPT_SELFSIGNED_CERT), tryConvertToBoolean(REMOTE_HUB_CONFIG.acceptSelfSignedCert)),
    };
}
exports.getRemoteHubConfig = getRemoteHubConfig;
