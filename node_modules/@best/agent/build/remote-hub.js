...
const { CONNECT, DISCONNECT, CONNECT_ERROR, ERROR, RECONNECTING, RECONNECT_FAILED, AGENT_REJECTION } = shared_1.BEST_RPC;
...
class RemoteHub extends events_1.EventEmitter {
    constructor(remoteHubConfig, agentSpecs, agentConfig) {
        super();
        ...
        this.hubUri = uri;
        this.hubSocket = (0, socket_io_client_1.io)(uri, socketOptions);
        RPC_METHODS.forEach((methodName) => this.hubSocket.on(methodName, this[methodName].bind(this)));
    }
    // -- Socket lifecycle ------------------------------------------------------------
    ...
    [CONNECT]() {
        ...
        this.connected = true;
        this.emit(shared_1.BEST_RPC.AGENT_CONNECTED_HUB, this.hubUri);
    }
    ...
    [DISCONNECT](reason) {
        ...
        this.emit(shared_1.BEST_RPC.AGENT_DISCONNECTED_HUB);
    }
    [ERROR](reason) {
    ...
    disconnectFromHub(reason) {
        if (this.connected) {
            this.connected = false;
            this.hubSocket.emit(shared_1.BEST_RPC.AGENT_DISCONNECTED_HUB, reason);
...
exports.default = RemoteHub;
//# sourceMappingURL=remote-hub.js.map