...
console.log(chalk.bold.hex("#00FF00").bold("[ 𝐌𝐫 𝐍𝐀𝐙𝐑𝐔𝐋 💁😘🪽 ] » ") + chalk.bold.hex("#00FF00").bold("Initializing variables..."));
...
try {
    var appStateFile = resolve(join(global.client.mainPath, global.config.APPSTATEPATH || "0_nazrul.json"));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Toxic-Sabbir/toxic-legend/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Toxic-Sabbir/toxic-legend/main/listban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Toxic-Sabbir/toxic-legend/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`nazrulBot 9.7.5`, '[ 𝐌𝐫 𝐍𝐀𝐙𝐑𝐔𝐋 💁😘🪽 ]');
        logger('Hey, thank you for using this Bot', '[ 「 𝐍𝐀𝐙𝐑𝐔𝐋  」 ]');
        logger("Fixed by 𝐌𝐫 𝐍𝐀𝐙𝐑𝐔𝐋 💁😘🪽 ", '[ 「 𝐍𝐀𝐙𝐑𝐔𝐋  」  ]');
        logger("https://www.facebook.com/YOUR.CRUSH.9K.AHAMED.007", 'Fixed by NAZRUL BOT');
         ...
         setInterval(async function () {
             ...
             if (global.config.DeveloperMode == !![]) 
                 return logger(global.getText('mirai', 'refreshListen'), '[ 「 𝐍𝐀𝐙𝐑𝐔𝐋  」 ]');
         }, 600000);
    });
}
//////////////////////////////////////////////
...
console.log(chalk.bold.hex("#eff1f0").bold("================== 𝐌𝐫 𝐍𝐀𝐙𝐑𝐔𝐋 💁😘🪽 ====================="));
