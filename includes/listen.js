...
(async function () {
    ...
    if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
      ...
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`•┄┅══════❁🌺❁══════┅┄•\n\n আপনার গ্রুপ এ approved নেই approved এর জন্য আমার বস কে ${prefix}request দেন\n\n  「 𝐍𝐀𝐙𝐑𝐔𝐋  」\n 
𝐂𝐫𝐞𝐚𝐭𝐨𝐫 :𝐌𝐫 𝐍𝐀𝐙𝐑𝐔𝐋 💁😘🪽 🌸\n

 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 : https://www.facebook.com/YOUR.CRUSH.9K.AHAMED.007\n

আপনার গ্রুপ এ যদি না হয়ে থাকে তো আপনি গ্রুপ admin কে add করতে পারেন আপনার গ্রুপ এ 😇\n

যে কোনো হেল্প এ জন্য আমার বস এর সাথে কথা বলুন - wp : 01936642379\n\n•┄┅══════❁🌺❁══════┅┄•`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
